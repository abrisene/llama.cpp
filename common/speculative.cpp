...
struct common_speculative_impl_draft_dflash : public common_speculative_impl {
    ...
    bool process(const llama_batch & batch_in) override {
        ...
        // Flatten target features into shared chunks while preserving each row's position and sequence.
        // The draft decoder now owns the encoder, so one decode both encodes the features and injects KV.
