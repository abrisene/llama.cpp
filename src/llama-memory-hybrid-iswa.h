...
public:
    ...
    // iSWA has no range-cache contract in version 1.  Keep the methods
    // explicit so capability introspection cannot accidentally inherit a
    // future default implementation.
