...
public:
    ...
    // Component-aware state streams used by the persistent prefix cache.  A
    // recurrent stream is a boundary snapshot, not a token-position slice;
    // the caller owns the versioned envelope around this payload.
