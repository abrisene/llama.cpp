...
| `--batch-coalesce-us N` | maximum admission coalescing window for burst requests in microseconds (default: 0, 0 = disabled, maximum: 2000)<br/>(env: LLAMA_ARG_BATCH_COALESCE_US) |
