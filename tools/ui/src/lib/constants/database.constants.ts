...
export const IDXDB_STORE_SCHEMAS = {
	...
	systemPrompts: 'id, name, updatedAt'
} as const;
...
/** v2 adds the systemPrompts table; existing installs migrate up via this diff */
export const IDXDB_STORES_V2 = {
	...IDXDB_STORES,
	[IDXDB_TABLES.systemPrompts]: IDXDB_STORE_SCHEMAS.systemPrompts
} as const;
